...
constexpr auto compare(InputIt first1, SentinelIt last1, InputIt first2, SentinelIt last2) {
...
constexpr auto compare(InputIt first1, SentinelIt last1, InputIt first2, SentinelIt last2, Equal &&eq) {
    while(first1 != last1 && first2 != last2) {
